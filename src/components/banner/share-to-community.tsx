...
export default function ShareToCommunity() {
    ...
    return (
        <div className="bg-[#f8fafc] py-[108px]">
            <Box>
                <div className="py-[86px] relative bg-primary text-center text-white">
                    ...
                    <h2 className="font-semibold font-poppins text-[45px] mb-[54px]">Share to your community, start selling</h2>
                    <button className="bg-[#FBC506] text-[18px] h-[65px] mx-auto w-full max-w-[658px]">
                        Start Selling
                    </button>
                </div>
            </Box>
