...
export default function Market() {
    ...
    return (
        <Box className="pb-[168px]">
            <header className="mb-[53px]">
                <h1 className="text-[26px] text-[#151517] font-semibold">On the Market</h1>
            </header>
            <div className="flex flex-col lg:flex-row gap-[40px]">
                <div className="w-full max-w-[315px]">
                    <div className="mb-[13px]">
                        <h2 className="text-[#252C32] mb-[8px] font-semibold">Price, ₦</h2>
                    ...
                    <div className="mb-[13px]">
                        ...
                        <div className="flex flex-col gap-[9.5px]">
                            ...
                            <div className="flex gap-[8px] items-center">
                                <div className="w-[18px] h-[18px] border-[1.13px] border-[#B0BABF] bg-[#F6F8F9]"></div>
                                <p className="text-[#252C32] text-[18px]">Courses</p>
                            </div>
                            <div className="flex gap-[8px] items-center">
                                <div className="w-[18px] h-[18px] border-[1.13px] border-[#B0BABF] bg-[#F6F8F9]"></div>
                                <p className="text-[#252C32] text-[18px]">Books</p>
                            </div>
                            <div className="flex gap-[8px] items-center">
                                <div className="w-[18px] h-[18px] border-[1.13px] border-[#B0BABF] bg-[#F6F8F9]"></div>
                                <p className="text-[#252C32] text-[18px]">Videos</p>
                            </div>
                            <div className="flex gap-[8px] items-center">
                                <div className="w-[18px] h-[18px] border-[1.13px] border-[#B0BABF] bg-[#F6F8F9]"></div>
                                <p className="text-[#252C32] text-[18px]">Free</p>
                            </div>
                        </div>
                    </div>
                    <div>
